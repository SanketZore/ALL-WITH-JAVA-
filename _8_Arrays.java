...
//     marks[5]=90;  // If you put more values than declared input then it will throw an error(Index 5 out of bounds for length 5).
...
//  String[] names={"Sanket","Rohit","sam","Himanshu","Shubham","Rahul","Viart","Sahil","Om","Ayush"};
...
Multidimensional arrays are array of arrays Each Element of a M-D array is an array itself marks in the previous example was a 1-D array.
...
//         if(num==RollNo[i]){
//             System.out.println(num+" match with the element at Index-Value "+i+" in the array.");
//         }
// }
